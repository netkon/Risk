...
func _on_AttackSliderA_value_changed(value):
	if $AddTroopsAttack/AttackSliderA.max_value != $AddTroopsAttack/AttackSliderA.min_value:
		$AddTroopsAttack/HMTroopsAttack.text = str(value)
		
func _on_TroopsSlider_value_changed(value):
	if $AddTroops/TroopsSlider.max_value != $AddTroops/TroopsSlider.min_value:
		$AddTroops/HMTroops.text = str(value)

func _on_DiceSlider_value_changed(value):
	if $AddDice/DiceSlider.max_value != $AddDice/DiceSlider.min_value:
...
func endGame():
	...
	$EndScreen/Appear.play("New Anim")
